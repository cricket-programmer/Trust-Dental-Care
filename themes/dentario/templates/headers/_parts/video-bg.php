<?php
if ($video_bg_show) {
	$youtube = dentario_get_custom_option('video_bg_youtube_code');
	$video   = dentario_get_custom_option('video_bg_url');
	$overlay = dentario_get_custom_option('video_bg_overlay')=='yes';
	if (!empty($youtube)) {
		?>
