...
if ( !function_exists( 'dentario_template_portfolio_theme_setup' ) ) {
	add_action( 'dentario_action_before_init_theme', 'dentario_template_portfolio_theme_setup', 1 );
	function dentario_template_portfolio_theme_setup() {
		dentario_add_template(array(
			'layout' => 'portfolio_2',
			'template' => 'portfolio',
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile (with hovers, different height) /2 columns/', 'dentario'),
		...
		dentario_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /3 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium image', 'dentario'),
			'w'		 => 370,
			'h_crop' => 209,
			'h'		 => null
		...
		dentario_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /4 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium image', 'dentario'),
			'w'		 => 370,
			'h_crop' => 209,
			'h'		 => null
		...
		dentario_add_template(array(
			...
			'title'  => esc_html__('Grid tile (with hovers, equal height) /2 columns/', 'dentario'),
		...
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /3 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 209
		));
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /4 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 209
		));
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile (with hovers, width=height) /2 columns/', 'dentario'),
		...
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /3 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 370
		));
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /4 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 370
		));
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored excerpt', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 370
		));
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile (with hovers, width=height) /2 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h' 	 => 370
		));
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /3 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 370
		));
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /4 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 370
		));
		dentario_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /2 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h' 	 => 370
		));
		dentario_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /3 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 370
		));
		dentario_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /4 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 370
		));
		dentario_add_template(array(
			...
			'title'  => esc_html__('Alternative grid (with hovers) /2 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h' 	 => 370
		));
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /3 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 370
		));
		dentario_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /4 columns/', 'dentario'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'dentario'),
			'w'		 => 370,
			'h'		 => 370
		));
		// Add template specific scripts
		add_action('dentario_action_blog_scripts', 'dentario_template_portfolio_add_scripts');
	}
}

// Add template specific scripts
if (!function_exists('dentario_template_portfolio_add_scripts')) {
	//add_action('dentario_action_blog_scripts', 'dentario_template_portfolio_add_scripts');
	function dentario_template_portfolio_add_scripts($style) {
		if (dentario_substr($style, 0, 10) == 'portfolio_' 
			|| dentario_substr($style, 0, 5) == 'grid_' 
			|| dentario_substr($style, 0, 7) == 'square_' 
			|| dentario_substr($style, 0, 6) == 'short_'
			|| dentario_substr($style, 0, 6) == 'alter_' 
			|| dentario_substr($style, 0, 8) == 'colored_') {
...
// Template output
if ( !function_exists( 'dentario_template_portfolio_output' ) ) {
	function dentario_template_portfolio_output($post_options, $post_data) {
		...
		if ($style == 'colored' && $columns==1) {				// colored excerpt style (1 column)
				...
				<<?php echo trim($tag); ?> class="post_item post_item_colored post_item_colored_1
					...
					<div class="post_content isotope_item_content">
						<div class="post_featured img">
							...
							dentario_template_set_args('reviews-summary', array(
								'post_options' => $post_options,
								'post_data' => $post_data
							));
							get_template_part(dentario_get_file_slug('templates/_parts/reviews-summary.php'));
							$reviews_summary = dentario_storage_get('reviews_summary');

							$new = dentario_get_custom_option('mark_as_new', '', $post_data['post_id'], $post_data['post_type']);					// !!!!!! Get option from specified post
							if ($new && $new > date('Y-m-d')) {
								?><div class="post_mark_new"><?php esc_html_e('NEW', 'dentario'); ?></div><?php
							}
							?>
						</div>
						...
						<div class="post_description clearfix">
							...
							<?php if ($post_data['post_link'] != '') { ?>
								<div class="post_buttons">
									<?php echo trim(dentario_sc_button(array('size'=>'small', 'link'=>$post_data['post_link']), esc_html__('LEARN MORE', 'dentario'))); ?>
								</div>
							<?php } ?>
						</div>
					</div>				<!-- /.post_content -->
			...
			if ($style=='alter') {
				...
				$alter_size = explode('_', dentario_get_custom_option('alter_thumb_size', '1_1', $post_data['post_id'], $post_data['post_type']));	// !!!!!! Get option from specified post
				$alter_size[0] = max(1, $alter_size[0]);
				$alter_size[1] = max(1, empty($alter_size[1]) ? 1 : $alter_size[1]);
				$post_data['post_thumb'] = dentario_get_resized_image_tag($post_data['post_attachment'], 
									...
									if ($post_data['post_protected']) {
										...
										if ($post_data['post_excerpt']) {
											echo in_array($post_data['post_format'], array('quote', 'link', 'chat', 'aside', 'status')) 
												...
												: '<p>' . ($link_start) 
													. (dentario_strpos($post_options['hover'], 'square')!==false
														? strip_tags($post_data['post_excerpt'])
														: trim(dentario_strshort($post_data['post_excerpt'], isset($post_options['descr']) ? $post_options['descr'] : dentario_get_custom_option('post_excerpt_maxlength_masonry'))) 
														)
													. ($link_end) . '</p>';
										}
