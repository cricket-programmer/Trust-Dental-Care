...
if ( !function_exists( 'dentario_template_news_portfolio_theme_setup' ) ) {
	add_action( 'dentario_action_before_init_theme', 'dentario_template_news_portfolio_theme_setup', 1 );
	function dentario_template_news_portfolio_theme_setup() {
		dentario_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'dentario'),
...
// Template output
if ( !function_exists( 'dentario_template_news_portfolio_output' ) ) {
	function dentario_template_news_portfolio_output($post_options, $post_data) {
