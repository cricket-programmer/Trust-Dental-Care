...
if ( !function_exists( 'dentario_template_services_5_theme_setup' ) ) {
	add_action( 'dentario_action_before_init_theme', 'dentario_template_services_5_theme_setup', 1 );
	function dentario_template_services_5_theme_setup() {
		dentario_add_template(array(
			'layout' => 'services-5',
			'template' => 'services-5',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 5/', 'dentario'),
...
// Template output
if ( !function_exists( 'dentario_template_services_5_output' ) ) {
	function dentario_template_services_5_output($post_options, $post_data) {
