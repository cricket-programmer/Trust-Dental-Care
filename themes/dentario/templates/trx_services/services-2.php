...
if ( !function_exists( 'dentario_template_services_2_theme_setup' ) ) {
	add_action( 'dentario_action_before_init_theme', 'dentario_template_services_2_theme_setup', 1 );
	function dentario_template_services_2_theme_setup() {
		dentario_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'dentario'),
...
// Template output
if ( !function_exists( 'dentario_template_services_2_output' ) ) {
	function dentario_template_services_2_output($post_options, $post_data) {
