...
if ( !function_exists( 'dentario_template_services_1_theme_setup' ) ) {
	add_action( 'dentario_action_before_init_theme', 'dentario_template_services_1_theme_setup', 1 );
	function dentario_template_services_1_theme_setup() {
		dentario_add_template(array(
			'layout' => 'services-1',
			'template' => 'services-1',
			'mode'   => 'services',
			'title'  => esc_html__('Services /Style 1/', 'dentario'),
...
// Template output
if ( !function_exists( 'dentario_template_services_1_output' ) ) {
	function dentario_template_services_1_output($post_options, $post_data) {
