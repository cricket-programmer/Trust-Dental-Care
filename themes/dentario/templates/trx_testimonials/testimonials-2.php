...
if ( !function_exists( 'dentario_template_testimonials_2_theme_setup' ) ) {
	add_action( 'dentario_action_before_init_theme', 'dentario_template_testimonials_2_theme_setup', 1 );
	function dentario_template_testimonials_2_theme_setup() {
		dentario_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 2/', 'dentario')
		));
	}
}

// Template output
if ( !function_exists( 'dentario_template_testimonials_2_output' ) ) {
	function dentario_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
