...
if ( !function_exists( 'dentario_template_testimonials_3_theme_setup' ) ) {
	add_action( 'dentario_action_before_init_theme', 'dentario_template_testimonials_3_theme_setup', 1 );
	function dentario_template_testimonials_3_theme_setup() {
		dentario_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 3/', 'dentario'),
			'thumb_title'  => esc_html__('Avatar (small)', 'dentario'),
			'w'		 => 75,
			'h'		 => 75
		));
	}
...
// Template output
if ( !function_exists( 'dentario_template_testimonials_3_output' ) ) {
	function dentario_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
