...
if (function_exists('vc_map_get_attributes')) {						// New VC
	...
	// Add Dentario color scheme in the row
	if ($scheme && !dentario_param_is_off($scheme) && !dentario_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	...
	// Add Dentario color scheme in the row
	if ($scheme && !dentario_param_is_off($scheme) && !dentario_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
