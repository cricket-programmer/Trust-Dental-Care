...
// Shortcode template
if ( ! class_exists( 'DENTARIO_VC_ShortCode' ) ) {
	abstract class DENTARIO_VC_ShortCode extends WPBakeryShortCode {
...
if ( ! class_exists( 'DENTARIO_VC_ShortCodeSingle' ) ) {
	abstract class DENTARIO_VC_ShortCodeSingle extends DENTARIO_VC_ShortCode {
	}
}

// Single shortcode without params (woocommerce_cart, checkout, etc.)
if ( ! class_exists( 'DENTARIO_VC_ShortCodeAlone' ) ) {
	abstract class DENTARIO_VC_ShortCodeAlone extends DENTARIO_VC_ShortCode {
		protected $controls_list = array('clone', 'delete');
	}
}

// Container shortcode (block, section, parallax)
if ( ! class_exists( 'DENTARIO_VC_ShortCodeContainer' ) ) {
	abstract class DENTARIO_VC_ShortCodeContainer extends DENTARIO_VC_ShortCode {
...
if ( ! class_exists( 'DENTARIO_VC_ShortCodeCollection' ) ) {
	abstract class DENTARIO_VC_ShortCodeCollection extends DENTARIO_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'DENTARIO_VC_ShortCodeItem' ) ) {
	abstract class DENTARIO_VC_ShortCodeItem extends DENTARIO_VC_ShortCode {
...
if ( ! class_exists( 'DENTARIO_VC_ShortCodeColumns' ) ) {
	abstract class DENTARIO_VC_ShortCodeColumns extends DENTARIO_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( !class_exists('DENTARIO_VC_ShortCodeAccordion') ) {
	abstract class DENTARIO_VC_ShortCodeAccordion extends WPBakeryShortCode_VC_Accordion {}
	abstract class DENTARIO_VC_ShortCodeAccordionItem extends WPBakeryShortCode_VC_Accordion_tab {}
}
if ( !class_exists('DENTARIO_VC_ShortCodeToggles') ) {
	abstract class DENTARIO_VC_ShortCodeToggles extends DENTARIO_VC_ShortCodeAccordion {}
	abstract class DENTARIO_VC_ShortCodeTogglesItem extends DENTARIO_VC_ShortCodeAccordionItem {}
}
...
if ( ! class_exists( 'DENTARIO_VC_ShortCodeTabs' ) ) {
	abstract class DENTARIO_VC_ShortCodeTabs extends WPBakeryShortCode_VC_Tabs {
		public function setCustomTabId( $content ) {
			return preg_replace( '/tab\_id\=\"([^\"]+)\"/', 'tab_id="sc_tab_$1_' . time() . '"', $content );
		}
	}
	abstract class DENTARIO_VC_ShortCodeTab extends WPBakeryShortCode_VC_Tab {
	}
}
